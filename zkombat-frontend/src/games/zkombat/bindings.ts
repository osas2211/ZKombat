...
export const networks = {
  testnet: {
    ...
    contractId: "CD3D2YYADCVELNDRJP6K24EIDVTBWQXY65N2SKCMFIJERWLGVRJNBJSS",
  }
} as const
...
export const Groth16Error = {
  100: {message:"InvalidProof"},
  101: {message:"MalformedPublicInputs"},
  102: {message:"MalformedProof"},
  103: {message:"NotInitialized"}
}
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "",
        ...
        "AAAABAAAAAAAAAAAAAAADEdyb3RoMTZFcnJvcgAAAAQAAAAAAAAADEludmFsaWRQcm9vZgAAAGQAAAAAAAAAFU1hbGZvcm1lZFB1YmxpY0lucHV0cwAAAAAAAGUAAAAAAAAADk1hbGZvcm1lZFByb29mAAAAAABmAAAAAAAAAA5Ob3RJbml0aWFsaXplZAAAAAAAZw==",
        "AAAAAQAAAC1Hcm90aDE2IHByb29mIGNvbXBvc2VkIG9mIEJOMjU0IGN1cnZlIHBvaW50cy4AAAAAAAAAAAAADEdyb3RoMTZQcm9vZgAAAAMAAAAAAAAAAWEAAAAAAAPuAAAAQAAAAAAAAAABYgAAAAAAA+4AAACAAAAAAAAAAAFjAAAAAAAD7gAAAEA=",
        "AAAAAQAAAAAAAAAAAAAAD1Byb29mU3VibWlzc2lvbgAAAAAFAAAAAAAAAAVpX3dvbgAAAAAAAAQAAAAAAAAACmlucHV0X2hhc2gAAAAAA+4AAAAgAAAAAAAAAA9teV9maW5hbF9oZWFsdGgAAAAABAAAAAAAAAAVb3Bwb25lbnRfZmluYWxfaGVhbHRoAAAAAAAABAAAAAAAAAASdG90YWxfZGFtYWdlX2RlYWx0AAAAAAAE",
        ...
        "",
