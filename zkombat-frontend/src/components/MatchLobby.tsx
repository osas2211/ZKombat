...
export function MatchLobby({ children }: MatchLobbyProps) {
  ...
  const isNegotiating =
    connectionState === "signaling" || connectionState === "reconnecting"
  ...
  return (
    <div className="card" style={{ maxWidth: 480, margin: "0 auto" }}>
      ...
      {error && (
        <div className="notice error" style={{ marginBottom: "1.25rem" }}>
          {error}
        </div>
      )}
        ...
        <div style={{ marginBottom: "1.5rem" }}>
          ...
          >
            ...
            <div>
              ...
              >
                Share this code:{" "}
                <strong style={{ fontSize: "1.1rem", letterSpacing: "0.15em" }}>
                  {roomId}
                </strong>
              </div>
            </div>
