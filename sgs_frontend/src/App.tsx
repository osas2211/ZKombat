      ...
      {!hasAnyContracts && (
        <div className="card" style={{ marginBottom: "2rem" }}>
          ...
          <p style={{ color: "var(--color-ink-muted)", marginTop: "1rem" }}>
            Contract IDs not configured. Please run <code>bun run setup</code>{" "}
            from the repo root to deploy contracts and configure the studio
            frontend.
          </p>
        </div>
      )}
